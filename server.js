...
//handler so only signed in can see
app.use(isSignedIn);
...
app.post('/listings/:listingId/favourited-by/:userId', listingsCtrl.addFavourtie)
app.delete('/listings/:listingId/favourited-by/:userId', listingsCtrl.removeFavourite)
